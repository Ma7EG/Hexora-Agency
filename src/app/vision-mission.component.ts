  ...
  template: `
    <section id="about" class="py-20 px-5 md:px-8 max-w-[1440px] mx-auto scroll-mt-20 relative z-10">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-stretch">
        <div class="glass-card p-8 md:p-12 rounded-3xl border border-[#e5e7eb] shadow-xl backdrop-blur-xl relative group hover:border-[#5b54fc]/60 hover:shadow-[0_20px_50px_rgba(91, 84, 252,0.15)] transition-all duration-500 bg-white/95 flex flex-col justify-between">
          <div>
            ...
            <p class="font-['Stapel'] text-[#4b5563] text-base md:text-lg leading-relaxed font-light">
